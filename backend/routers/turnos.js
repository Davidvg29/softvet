...
const {mostrarTurnos,mostrarTurnoId,crearTurno,editarTurno,eliminarTurno,horariosDisponibles} = require('../controllers/turnos');
const { verifyToken } = require('../middlewares/jwt');

const router = express.Router();    

router.get('/ver', verifyToken, mostrarTurnos);
router.get('/horariosDisponibles', horariosDisponibles);
