...
import VerHistoriaClinica from "../HistoriaClinica/VerHistoriaClinica";
...
const MainMascota = () => {
  ...
  const TITULOS = {
    ...
    verHistoriaClinica: "Historia Clínica"
  };
...
`}
                ...
                mascotasPaginados.map((m) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {(rolUsuario === "Administrador" || rolUsuario === "Veterinario") && (<Button
                        style={{
                          backgroundColor: "#6f42c1",
                          border: "none",
                          fontWeight: "bold",
                        ...
                        onClick={() => {
                          if (m.id_historia_clinica) {
                            handleOpenModal("verHistoriaClinica", m.id_historia_clinica);
                          } else {
                            Swal.fire({
                              icon: "info",
                              title: "Sin historia clínica",
                              text: "Esta mascota todavía no tiene una historia clínica asignada.",
                              confirmButtonColor: "#6f42c1",
                            });
                          }
                        }}
  ...
  style={{ "--bs-modal-width": "750px" }} // 👈 tamaño ideal
>
  <div
    style={{
      maxWidth: "750px",
  ...
  >
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
        {modalType === "ver" && (
          <VerMascota id_mascota={mascotaId} />
        )}
