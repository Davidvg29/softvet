...
const MainRaza = () => {
    ...
    const razasOrdenadas = [...razasFiltradas].reverse();

    const indiceUltimoElemento = paginaActual * elementosPorPagina;
    const indicePrimerElemento = indiceUltimoElemento - elementosPorPagina;
    const razasPaginadas = razasOrdenadas.slice(
        indicePrimerElemento,
        indiceUltimoElemento
    );
    const totalPaginas = Math.ceil(
        razasOrdenadas.length / elementosPorPagina
    );
...
>
  <div
    style={{
      ...
      boxShadow: "0 15px 40px rgba(111,66,193,0.2)",
  ...
  >
    ...
    <div
      style={{
        ...
        inset: 0,
        borderRadius: "22px",
        boxShadow: "0 0 30px rgba(111,66,193,0.2)",
        pointerEvents: "none",
      }}
    />
